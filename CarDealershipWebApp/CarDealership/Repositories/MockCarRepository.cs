    ...
    public class MockCarRepository : ICarRepository
    {
        public static List<Car> cars = new List<Car>()
        {
                  new Car()
            {
                ...
                Model = "Durango",
                Year = "2015",
                ImageUrl = @"http://pictures.dealer.com/g/gossdodgecllc/1208/bbeca4bafa3c8161110e4b4306e8f418x.jpg",
                Title = "THIS IS A COOL CAR MAN",
                Description = "LETS GO RACING!! ",
                Price = 30495M
            },
            new Car()
            {
             ...
             new Car()
            {
                ...
                Model = "TL",
                Year = "2016",
                ImageUrl = @"http://acuraconnected.com/wp-content/uploads/2014/08/tlx_629_2014_08_12_02.jpg",
                Title = "THIS IS A COOL CAR MAN",
                Description = "LETS GO RACING!! ",
                Price = 9999M
            },
